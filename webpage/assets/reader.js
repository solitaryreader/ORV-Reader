...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function applySettings() {
        ...
        if (theme === "dark") {
            ...
            root.style.setProperty("--icons-color", "");
            root.style.setProperty("--icons-color", "brightness(40%)");
            changeGiscusTheme("gruvbox_light");
            ...
            changeGiscusTheme("transparent_dark");
            ...
            root.style.setProperty("--icons-color", "brightness(40%)");
            changeGiscusTheme("catppuccin_latte");
            ...
            root.style.setProperty("--icons-color", "brightness(100%)");
            changeGiscusTheme("gruvbox_dark");
            ...
            root.style.setProperty("--icons-color", "brightness(100%)");
            changeGiscusTheme("catppuccin_frappe");
            ...
            root.style.setProperty("--icons-color", "brightness(100%)");
            changeGiscusTheme("catppuccin_mocha");
        }
